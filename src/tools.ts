...
10. desktop_screenshot
   - Описание: Сделать скриншот всего экрана монитора (macOS/Windows).
   - Формат вызова:
     \`\`\`desktop:screenshot <путь/к/файлу.png>\`\`\`

11. desktop_act
   - Описание: Управление клавиатурой (macOS/Windows). Полезно для ввода текста в открытые окна (например, Xcode).
   - Формат вызова:
